import { CREATE_USER, ADD_USER, REMOVE_USER, CHECK_USER, RECEIVE_USER, DEAUTHENTICATE_USER, CHECK_AUTHENTICATION_STATUS } from './types';
...
export const createUser = (user) => dispatch => {
  ...
  .then ((res) => {
    dispatch ({
      type: RECEIVE_USER,
      payload: res.data  //  the resoponse that came form the backend with the user
    })
  })
}
